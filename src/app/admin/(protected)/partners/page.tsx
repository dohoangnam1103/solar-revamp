    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-6">
        ...
        <form action={createPartner} className="flex flex-wrap items-end gap-3">
          ...
          <div><label className="block text-xs text-gray-500 mb-1">Logo</label><input name="logo" type="file" accept="image/jpeg,image/png,image/webp,image/gif" className="w-48 rounded-lg border border-gray-300 px-3 py-2 text-sm file:mr-3 file:rounded-md file:border-0 file:bg-green-50 file:px-3 file:py-1.5 file:text-sm file:font-semibold file:text-green-700" /></div>
