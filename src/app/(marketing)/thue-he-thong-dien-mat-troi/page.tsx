        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-6">
              Thuê hệ thống solar —{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-yellow-300">0đ đầu tư ban đầu</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="tel:0902211893" className="flex items-center gap-2 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="glass rounded-2xl p-8 border border-white/50">
              ...
              <div className="space-y-4">
                {[
                  { label: 'Đầu tư ban đầu', mua: '50-200 triệu', thue: '0đ', highlight: true },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { icon: Shield, title: 'Không có vốn đầu tư', desc: 'Muốn tiết kiệm điện ngay nhưng chưa có ngân sách 50-200 triệu.' },
          ...
          <div className="mt-10 text-center">
            <a href="tel:0902211893" className="inline-flex items-center gap-2 px-8 py-4 bg-green-700 hover:bg-green-800 text-white font-bold rounded-xl transition-colors text-lg">
